          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/danielkeb/dbuprm" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                <a href="https://dbuprm.vercel.app" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> </div>
            </header>
            <div className="body">
              <h3>The PRMS for DBU project was developed to seamlessly protect personal computers from theft. </h3>
              <p> This system is designed for the university community to streamline PC registration and management. It incorporates features such as barcode and QR code generation, along with PC  </p>
            </div>
            <footer> <ul className="tech-list"> <li>NextJs</li> <li>NestJs</li><li>Prisma</li><li>Postgresql</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/danielkeb/Abune_Gorgoriwos_school_maangement_system" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://e" target="_blank" rel="noreferrer">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/danielkeb/friendship-hotel-redesign" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://friendshiphotel.vercel.app/" target="\_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Friendship Hotel Portfolio Website</h3>
              <p>
              Developed with an attractive UI, providing ample information for customers, including room booking options.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/danielkeb/getPcrm-mobile-version" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
            ...
            <div className="body">
              <h3>PRMs Mobile Application version</h3>
              <p>Developed with a simple user interface featuring functions such as barcode reading, registration, recent actions, and SEO.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Flutter</li>
                <li>Dart</li>
                <li>Restful Api(NestJs)</li>
              </ul>
            </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/danielkeb/xoka-hr" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              ...
              <p>Developed an HR management system with comprehensive functionality, including employee salary management, attendance tracking, performance assessments, the hiring process for candidates, and other essential features.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Angular</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
              <div className="project-links">
                <a href="https://github.com/danielkeb/agsms-mobile-version" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>School Management System Mobile application version</h3>
              <p>
              Developed for students and parents, featuring a simple and attractive UI with functionalities such as providing reading materials for students and access to their results.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
